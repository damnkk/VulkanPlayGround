...
namespace Play{
    ...
    enum class GBufferType : int {
        GBufferA = 0,   // BaseColor
        GBufferB,       // WorldNormal
        GBufferC,       // PBR
        GBufferD,       // Custom Data
        Velocity,       // Motion Objects
    ...
    struct GBufferRTParam{
        ...
        bool IsDepth() const { 
             return type == GBufferType::SceneDepth; 
        }
    };
